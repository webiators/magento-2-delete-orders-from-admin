 ...
 */
namespace Webiators\DeleteOrdersFromAdmin\Model\Creditmemo;
...
class Delete
{
     ...
     * @throws \Exception
     */
    public function deleteCreditmemoFromAdmin($creditmemoId)
    {
        $connection = $this->resource->getConnection(\Magento\Framework\App\ResourceConnection::DEFAULT_CONNECTION);
        $creditmemoGridTable = $connection->getTableName($this->helper->getTableName('sales_creditmemo_grid'));
        $creditmemoTable = $connection->getTableName($this->helper->getTableName('sales_creditmemo'));
